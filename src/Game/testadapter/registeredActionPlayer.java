...
public class registeredActionPlayer implements Player {
     ...
     *
     */
    @Override public PlayerView getMyView() {
        return myView;
    }
    @Override public void setPlayerName() {
        name = "Player";
    }
    @Override public void setPlayerView(PlayerView newView) {
        myView = newView;
    }
     ...
     *
     */
    @Override public Collection<Card> initialSwapCardsInteraction() {
        return myView.getHand().subList(0,Game.NO_CARDS_TO_SWAP - 1);
    }

    @Override public Map<Disk, Card> initialCardPlacementInteraction() {
        int count = 0;
    ...
    @Override public void notifyOfLoss(String winner) {}
    @Override public void notifyOfWin() {}
    @Override public void sendMessage(String in){}
    ...
    @Override  public int integerInteraction(String question, int maxVal, int minVal) {
    ...
    @Override public Map<Disk, Card> cardPlacer(Collection<Card> cards, String titleMessage, String perCardMessage) {
        return null;  //To change body of implemented methods use File | Settings | File Templates.
    }
    ...
    @Override public Map<Disk, Card> cardMultiPlacer(Collection<Card> toChooseFrom, boolean mustPlaceAll) {
        return null;  //To change body of implemented methods use File | Settings | File Templates.
    }
    ...
    @Override public void printGameState() {}
}
